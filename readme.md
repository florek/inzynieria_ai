...
Aktualny zakres notatek obejmuje m.in. **wstęp, rozdział 1 w całości oraz rozszerzony fragment rozdziału 2** opracowania w materiale źródłowym (paginacja jak w podglądzie **Strona N** w pliku HTML wygenerowanym z PDF), zsynchronizowany z eksporterem PDF do **linii 1428** w tym pliku HTML, tj. m.in. początek podrozdziału o rozmiarze modelu wraz z szacunkiem pamięci, rzadkością wag i wprowadzeniem do architektury MoE z przykładem łącznej liczby parametrów po częściowym współdzieleniu.
