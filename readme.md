...
Aktualny zakres notatek obejmuje m.in. **wstęp, rozdział 1 w całości oraz rozszerzony fragment rozdziału 2** opracowania w materiale źródłowym (paginacja jak w podglądzie **Strona N** w pliku HTML wygenerowanym z PDF), zsynchronizowany z eksporterem PDF do **linii 1553** w tym pliku HTML, tj. m.in. dane treningowe, wielojęzyczność, architekturę transformera i alternatywy, rozmiar modelu, MoE, FLOP i prawo skalowania Chinchilli, wąskie gardła skalowania (dane i energia), hiperparametry i ekstrapolację skalowania oraz wprowadzenie do post-treningu (SFT, dostrajanie preferencji, RLHF, DPO).
