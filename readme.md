...
Aktualny zakres notatek obejmuje m.in. **wstęp, rozdział 1 w całości oraz początek rozdziału 2** opracowania do **siedemdziesiątej strony włącznie** w materiale źródłowym (paginacja odpowiada oznaczeniom **Strona N** w eksporcie HTML z PDF).
