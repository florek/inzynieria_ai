...
Aktualny zakres notatek obejmuje m.in. **wstęp, rozdział 1 w całości oraz rozszerzony fragment rozdziału 2** opracowania do **końca strony 82 włącznie** w materiale źródłowym (paginacja jak w podglądzie **Strona N** w pliku HTML wygenerowanym z PDF), co odpowiada ujęciu treści w repozytorium do ustalonej granicy linii w tym eksporcie.
