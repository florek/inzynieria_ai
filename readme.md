...
Aktualny zakres notatek obejmuje m.in. **wstęp i rozdział 1** opracowania do **około pięćdziesiątej strony** w materiale źródłowym (paginacja odpowiada oznaczeniom **Strona N** w pliku HTML).
